...
process = cms.Process('HCALcpu',eras.Run2_2018)
...
# this is with PU (50) this is on cmg-gpu1080
#        'file:/data/patatrack/dalfonso/data/2018/Run2018A_HLTPhysics_316457/A4B5F486-5A59-E811-80A4-02163E01A052.root'
# this is on fu-c2d41-12-01
#        'file:/data/store/dalfonso/Run2018A_HLTPhysics_316457_A4B5F486-5A59-E811-80A4-02163E01A052.root'
...
# we will not run Time at HLT
#process.hbheprereco.algorithm.__setattr__('calculateArrivalTime',cms.bool(False))
#process.hbheprereco.algorithm.__setattr__('nMaxItersMin',cms.int32(10))
#process.hbheprereco.algorithm.__setattr__('nMaxItersNNLS',cms.int32(10))
#process.hbheprereco.algorithm.__setattr__('chiSqSwitch',cms.int32(-1))
