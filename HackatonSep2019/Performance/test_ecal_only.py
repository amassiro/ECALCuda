...
#process.ecalUncalibRecHit = cms.EDProducer("EcalUncalibRecHitConvertGPU2CPUFormat",
process.ecalMultiFitUncalibRecHit = cms.EDProducer("EcalUncalibRecHitConvertGPU2CPUFormat",
    recHitsLabelGPUEB = cms.InputTag("ecalCPUUncalibRecHitProducer", "EcalUncalibRecHitsEB"),
    recHitsLabelGPUEE = cms.InputTag("ecalCPUUncalibRecHitProducer", "EcalUncalibRecHitsEE"),
...
process.ecalRecHitProducerGPU.maxNumberHits = cms.uint32(20000)
...
#   gpu
    ...
    *process.ecalCPUUncalibRecHitProducer           # copy to host
    #*process.ecalUncalibRecHit                      # convert to legacy format  --->    *process.ecalUncalibRecHitConvertGPU2CPUFormat   # convert to legacy format
